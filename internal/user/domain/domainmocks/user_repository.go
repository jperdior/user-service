...
func (_m *UserRepository) FindByID(id kitdomain.UuidValueObject) (*domain.User, error) {
	ret := _m.Called(id)
	...
	var r0 *domain.User
	var r1 error
	if rf, ok := ret.Get(0).(func(kitdomain.UuidValueObject) (*domain.User, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(kitdomain.UuidValueObject) *domain.User); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domain.User)
	...
	if rf, ok := ret.Get(1).(func(kitdomain.UuidValueObject) error); ok {
		r1 = rf(id)
	} else {
		r1 = ret.Error(1)
	}
